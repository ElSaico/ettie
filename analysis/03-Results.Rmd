...
#)
results <- run.benchmark(data, parallel = TRUE)
...
# TODO: make each individual x-axis scale independent
ggbarplot(performances.per.measure, x = 'learner.id', y = 'mean', facet.by = 'measure',
          fill = 'learner.id', color = 'learner.id', xlab = FALSE, ylab = FALSE,
          x.text.angle = 45, legend = 'none')
```
